...
export default function SmartSpreadsheetDashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0a0a0a] text-[#ededed] font-sans w-full max-w-full min-w-0">
      {/* Top Banner - Vercel Theme */}
      <div className="border-b border-[#1f1f1f] bg-[#0a0a0a] px-3 sm:px-6 py-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-md bg-[#121212] px-2 py-0.5 text-xs font-mono font-semibold text-zinc-300 border border-[#1f1f1f]">
                Pipeline SSOT
              </span>
            </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-6">
          ...
          <div className="vercel-card p-3">
            ...
            <div className="mt-1.5 flex items-baseline justify-between">
              ...
              <span className={`text-[10px] font-mono font-semibold px-1.5 py-0.2 rounded ${blockedCount > 0 ? 'text-rose-400 bg-rose-500/10 border border-rose-500/20' : 'text-zinc-400 bg-[#141414]'}`}>
                blockers
              </span>
            </div>
          </div>
        ...
        <div className="mt-3.5 flex flex-col lg:flex-row lg:items-center justify-between gap-2.5 border-t border-[#1f1f1f] pt-3 text-xs">
          <div className="flex flex-wrap items-center gap-3 ml-4">
            ...
            <select
              ...
              className="rounded-md border border-[#1f1f1f] bg-[#0a0a0a] px-2.5 py-1.5 text-xs font-semibold text-zinc-200 focus:border-zinc-500 focus:outline-hidden [color-scheme:dark] hover:border-[#444] transition-colors cursor-pointer"
            >
              <option value="ALL" className="bg-[#0a0a0a] text-zinc-100">All Markets</option>
              <option value="CA" className="bg-[#0a0a0a] text-zinc-100">🇨🇦 CA</option>
              <option value="UK" className="bg-[#0a0a0a] text-zinc-100">🇬🇧 UK</option>
              <option value="US" className="bg-[#0a0a0a] text-zinc-100">🇺🇸 US</option>
              <option value="AUS" className="bg-[#0a0a0a] text-zinc-100">🇦🇺 AUS</option>
            </select>
            ...
            <select
              ...
              className="rounded-md border border-[#1f1f1f] bg-[#0a0a0a] px-2.5 py-1.5 text-xs font-semibold text-zinc-200 focus:border-zinc-500 focus:outline-hidden [color-scheme:dark] hover:border-[#444] transition-colors cursor-pointer"
            >
              <option value="ALL" className="bg-[#0a0a0a] text-zinc-100">All Priorities</option>
              <option value="P1" className="bg-[#0a0a0a] text-zinc-100">🔥 P1</option>
              <option value="P2" className="bg-[#0a0a0a] text-zinc-100">⏱️ P2</option>
              <option value="P3" className="bg-[#0a0a0a] text-zinc-100">📦 P3</option>
            </select>
            ...
            <select
              ...
              className="rounded-md border border-[#1f1f1f] bg-[#0a0a0a] px-2.5 py-1.5 text-xs font-semibold text-zinc-200 focus:border-zinc-500 focus:outline-hidden [color-scheme:dark] hover:border-[#444] transition-colors cursor-pointer"
            >
              <option value="ALL" className="bg-[#0a0a0a] text-zinc-100">All Owners</option>
              <option value="Yzah" className="bg-[#0a0a0a] text-zinc-100">Yzah (Creative)</option>
              <option value="Karl" className="bg-[#0a0a0a] text-zinc-100">Karl (Setup)</option>
              <option value="Mark" className="bg-[#0a0a0a] text-zinc-100">Mark (Setup)</option>
              <option value="Christian" className="bg-[#0a0a0a] text-zinc-100">Christian (Setup)</option>
              <option value="Charles" className="bg-[#0a0a0a] text-zinc-100">Charles (Buyer)</option>
            </select>

            <div className="flex items-center gap-1.5 pl-1 sm:pl-2 border-l border-[#1f1f1f]">
              <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider hidden sm:inline font-mono">
                Group:
              </span>
              <select
                value={groupBy}
                ...
                className="rounded-md border border-[#1f1f1f] bg-[#0a0a0a] px-2.5 py-1.5 text-xs font-semibold text-zinc-200 focus:border-zinc-500 focus:outline-hidden [color-scheme:dark] hover:border-[#444] transition-colors cursor-pointer"
              >
                <option value="none" className="bg-[#0a0a0a] text-zinc-100">None (Flat)</option>
                <option value="campaign" className="bg-[#0a0a0a] text-zinc-100">Campaign</option>
                <option value="product" className="bg-[#0a0a0a] text-zinc-100">Product</option>
                <option value="owner" className="bg-[#0a0a0a] text-zinc-100">Owner</option>
                <option value="stage" className="bg-[#0a0a0a] text-zinc-100">Stage</option>
              </select>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {/* View Mode Toggle */}
            <div className="flex items-center rounded-md bg-[#0a0a0a] border border-[#1f1f1f] p-0.5 text-xs shrink-0">
              <button
                type="button"
            ...
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                className="w-full rounded-md border border-[#1f1f1f] bg-[#0a0a0a] py-1.5 pl-8 pr-8 text-xs text-white placeholder-zinc-500 focus:border-zinc-500 focus:outline-hidden transition-colors"
              />
        ...
        {viewMode === 'cards' ? (
              ...
              <div key={groupTitle} className="space-y-3">
                {groupBy !== 'none' && (
                  <div className="flex items-center justify-between border-b border-[#1f1f1f] pb-2">
                    ...
                    <span className="rounded-full bg-[#141414] border border-[#1f1f1f] px-2 py-0.5 text-[10px] font-mono text-zinc-400">
                      ...
                      >
                        <div>
                          ...
                          <div className="flex items-center justify-between gap-2 border-b border-[#1f1f1f] pb-2.5 mb-2.5">
                            ...
                            <select
                              ...
                              style={{ colorScheme: 'dark' }}
                              className={`rounded px-2 py-0.5 text-xs font-semibold cursor-pointer border bg-[#0a0a0a] ${getStatusBadgeStyle(task.status)} [color-scheme:dark]`}
                            >
                              <option value="QUEUE" className="bg-[#0a0a0a] text-zinc-100">QUEUE</option>
                              <option value="MAKING" className="bg-[#0a0a0a] text-zinc-100">MAKING</option>
                              <option value="FOR REVIEW" className="bg-[#0a0a0a] text-zinc-100">FOR REVIEW</option>
                              <option value="CHANGES REQUIRED" className="bg-[#0a0a0a] text-zinc-100">CHANGES REQUIRED</option>
                              <option value="APPROVED" className="bg-[#0a0a0a] text-zinc-100">APPROVED</option>
                              <option value="READY" className="bg-[#0a0a0a] text-zinc-100">READY</option>
                              <option value="IN_SETUP" className="bg-[#0a0a0a] text-zinc-100">IN_SETUP</option>
                              <option value="QA" className="bg-[#0a0a0a] text-zinc-100">QA</option>
                              <option value="LIVE" className="bg-[#0a0a0a] text-zinc-100">LIVE</option>
                              <option value="BLOCKED" className="bg-[#0a0a0a] text-zinc-100">BLOCKED</option>
                            </select>
                          </div>
                          ...
                          <div className="mt-2.5 flex flex-wrap items-center gap-1.5">
                            <span className="rounded bg-[#141414] border border-[#1f1f1f] px-2 py-0.5 font-semibold text-zinc-200 text-xs">
                              {task.action}
                            </span>
                            <span className="font-mono text-[11px] text-zinc-400 bg-[#0a0a0a] px-2 py-0.5 rounded border border-[#1f1f1f]">
                              {task.adAccount}
                            </span>
                          </div>

                          {/* Next Action & Deadline */}
                          <div className="mt-3 rounded-lg bg-[#0a0a0a] border border-[#1f1f1f] p-2.5 text-xs">
                            <span className="text-[10px] font-bold text-zinc-400 uppercase block font-mono">Next Action</span>
                        ...
                        <div className="mt-3.5 pt-3 border-t border-[#1f1f1f] flex items-center justify-between gap-2">
                          <div className="flex items-center gap-1.5 text-xs font-semibold">
                            <span className="text-[11px] text-zinc-400 font-mono">Owner:</span>
                            <select
                              value={task.owner}
                              onChange={(e) => handleInlineOwnerChange(task, e.target.value)}
                              style={{ colorScheme: 'dark' }}
                              className="rounded-md bg-[#0a0a0a] text-xs font-semibold text-zinc-200 border border-[#1f1f1f] px-2 py-1 cursor-pointer focus:outline-hidden [color-scheme:dark] hover:border-[#444] transition-colors"
                            >
                              <option value="Yzah" className="bg-[#0a0a0a] text-zinc-100">Yzah (Creative)</option>
                              <option value="Karl" className="bg-[#0a0a0a] text-zinc-100">Karl (Setup)</option>
                              <option value="Mark" className="bg-[#0a0a0a] text-zinc-100">Mark (Setup)</option>
          ...
          <div className="w-full max-w-full min-w-0 space-y-2">
            <div className="flex flex-wrap items-center justify-between gap-2 text-[11px] text-zinc-400 px-1">
              ...
              <div className="flex items-center gap-2">
                <span className="font-mono text-[10px] bg-[#121212] px-2 py-0.5 rounded text-zinc-400 border border-[#1f1f1f]">
                  {filteredTasks.length} {filteredTasks.length === 1 ? 'task' : 'tasks'}
                </span>
              </div>
            </div>

            <div className={`w-full max-w-full min-w-0 rounded-xl border border-[#1f1f1f] bg-[#0a0a0a] shadow-xs custom-scrollbar `}>
              <table className={`w-full text-left text-xs border-collapse `}>
                <thead className="border-b border-[#1f1f1f] bg-[#0a0a0a] font-semibold text-zinc-400 uppercase tracking-wider text-[10px] sticky top-0">
                  <tr>
                    <th className={` border-r border-[#1f1f1f]`}>Priority</th>
                    <th className={` border-r border-[#1f1f1f]`}>Mkt</th>
                    <th className={` border-r border-[#1f1f1f]`}>Product</th>
                    <th className={` border-r border-[#1f1f1f]`}>Campaign</th>
                    <th className={` border-r border-[#1f1f1f]`}>Account</th>
                    <th className={` border-r border-[#1f1f1f]`}>Action</th>
                    <th className={` border-r border-[#1f1f1f]`}>Owner</th>
                    <th className={` border-r border-[#1f1f1f]`}>Stage</th>
                    <th className={` border-r border-[#1f1f1f]`}>Deadline</th>
                    <th className={` border-r border-[#1f1f1f]`}>Status</th>
                    <th className={` border-r border-[#1f1f1f]`}>Next Action</th>
                    ...
                    <React.Fragment key={groupTitle}>
                      {groupBy !== 'none' && (
                        <tr className="bg-[#121212] font-semibold text-xs text-white">
                          <td colSpan={12} className="py-2 px-3 border-y border-[#1f1f1f]">
                      ...
                      {groupItems.map((task) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className={` border-r border-[#1f1f1f] whitespace-nowrap`}>
                              <select
                                value={task.priority}
                                onChange={(e) => handleInlinePriorityChange(task, e.target.value as Priority)}
                                style={{ colorScheme: 'dark' }}
                                className="w-full rounded-md bg-[#0a0a0a] text-zinc-200 border border-[#1f1f1f] px-1 py-0.5 font-bold text-[11px] cursor-pointer focus:outline-hidden [color-scheme:dark] hover:border-[#444] transition-colors"
                              >
                                <option value="P1" className="bg-[#0a0a0a] text-zinc-100">🔥 P1</option>
                                <option value="P2" className="bg-[#0a0a0a] text-zinc-100">⏱️ P2</option>
                                <option value="P3" className="bg-[#0a0a0a] text-zinc-100">📦 P3</option>
                            ...
                            {/* Product */}
                            <td className={` border-r border-[#1f1f1f] font-semibold text-white whitespace-nowrap`}>
                            ...
                            {/* Campaign */}
                            <td className={` border-r border-[#1f1f1f] font-mono font-bold text-white hover:text-purple-300 whitespace-nowrap`}>
                              <button
                                onClick={() => {
                            ...
                            {/* Ad Account */}
                            <td className={` border-r border-[#1f1f1f] font-mono text-[10px] font-bold text-zinc-400 whitespace-nowrap`}>
                            ...
                            <td className={` border-r border-[#1f1f1f] whitespace-nowrap`}>
                              <span
                                className="rounded bg-[#141414] border border-[#1f1f1f] px-1.5 py-0.5 font-semibold text-zinc-300 text-[10px] truncate block max-w-[100px]"
                                title={task.action}
                              >
                                {task.action}
                              </span>
                            ...
                            <td className={` border-r border-[#1f1f1f] whitespace-nowrap font-semibold`}>
                              <select
                                value={task.owner}
                                onChange={(e) => handleInlineOwnerChange(task, e.target.value)}
                                style={{ colorScheme: 'dark' }}
                                className="w-full rounded-md bg-[#0a0a0a] text-[11px] font-semibold text-zinc-200 border border-[#1f1f1f] px-1 py-0.5 cursor-pointer focus:outline-hidden [color-scheme:dark] hover:border-[#444] transition-colors truncate"
                                title={`Owner: ${task.owner}`}
                              >
                                <option value="Yzah" className="bg-[#0a0a0a] text-zinc-100 py-1">Yzah</option>
                                <option value="Karl" className="bg-[#0a0a0a] text-zinc-100 py-1">Karl</option>
                                <option value="Mark" className="bg-[#0a0a0a] text-zinc-100 py-1">Mark</option>
                                <option value="Christian" className="bg-[#0a0a0a] text-zinc-100 py-1">Christian</option>
                                <option value="Charles" className="bg-[#0a0a0a] text-zinc-100 py-1">Charles</option>
                              </select>
                            </td>
                            ...
                            {/* Deadline */}
                            <td className={` border-r border-[#1f1f1f] font-mono text-[10px] whitespace-nowrap text-zinc-400`}>
                            ...
                            <td className={` border-r border-[#1f1f1f] whitespace-nowrap`}>
                              <select
                                ...
                                onChange={(e) => handleInlineStatusChange(task, e.target.value as WorkStatus)}
                                style={{ colorScheme: 'dark' }}
                                className={`w-full rounded-md px-1.5 py-0.5 text-[10px] font-semibold cursor-pointer border bg-[#0a0a0a] ${getStatusBadgeStyle(task.status)} focus:outline-hidden [color-scheme:dark] truncate`}
                                title={`Status: ${task.status}`}
                              >
                                <option value="QUEUE" className="bg-[#0a0a0a] text-zinc-100">QUEUE</option>
                                <option value="MAKING" className="bg-[#0a0a0a] text-zinc-100">MAKING</option>
                                <option value="FOR REVIEW" className="bg-[#0a0a0a] text-zinc-100">FOR REVIEW</option>
                                <option value="CHANGES REQUIRED" className="bg-[#0a0a0a] text-zinc-100">CHANGES REQ</option>
                                <option value="APPROVED" className="bg-[#0a0a0a] text-zinc-100">APPROVED</option>
                                <option value="READY" className="bg-[#0a0a0a] text-zinc-100">READY</option>
                                <option value="IN_SETUP" className="bg-[#0a0a0a] text-zinc-100">IN SETUP</option>
                                <option value="QA" className="bg-[#0a0a0a] text-zinc-100">QA</option>
                                <option value="LIVE" className="bg-[#0a0a0a] text-zinc-100">LIVE</option>
                                <option value="BLOCKED" className="bg-[#0a0a0a] text-zinc-100">BLOCKED</option>
                              </select>
                            ...
                            {/* Next Action */}
                            <td className={` border-r border-[#1f1f1f] text-[11px] text-zinc-300`}>
